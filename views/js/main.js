...
var items;
/**
 * @description This function updates the position of pizzas in the background
 * @param {string} x - 'x' will be a string when the function is called during initialization
 * @param {object} x - 'x' will be an object containing event data during the scroll event
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updatePositions('init'); //'init' is passed as parameter to indicate that initialization of position is required.
});